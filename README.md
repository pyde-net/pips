...
2. The accepted PIP specifies an **activation slot**. For Standards Track PIPs, the activation slot must be at least **6,500,000 slots** (≈ 30 days at 400ms slots) after the PIP enters `Accepted`. This gives validators time to upgrade binaries.
